    ...
    <nav className="fixed w-full bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800/50 z-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Desktop Menu */}
          <div className="hidden md:flex items-center justify-center xl:absolute xl:left-1/2 xl:transform xl:-translate-x-1/2 space-x-4 xl:space-x-6">
          ...
          <div className="border-r text-zinc-300 pr-4">
              <LanguageSwitcher/>
            </div>

            <Link href="/trainer/login" className="text-zinc-300 hover:text-white px-4 py-2 text-nowrap">
              {t('trainerLogin')}
            </Link>
            <Link href="/user/login" className="text-zinc-900 bg-white hover:bg-zinc-100 px-4 py-2 rounded-lg text-nowrap">
              {t('userLogin')}
            </Link>
          </div>
