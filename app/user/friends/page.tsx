        ...
        <div className="container mx-auto p-8 max-w-[1200px]">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-zinc-400 mt-1">Arkadaşlarını yönet ve yeni arkadaşlar ekle</p>
            </div>
            <div className="flex gap-3">
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md bg-zinc-900 border-zinc-800">
                  <DialogHeader>
                    <DialogTitle className="text-xl font-semibold text-white">Arkadaşlık İstekleri</DialogTitle>
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md bg-zinc-900 border-zinc-800">
                  <DialogHeader>
                    <DialogTitle className="text-xl font-semibold text-white">Arkadaş Ekle</DialogTitle>
                    <DialogClose className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-zinc-800 data-[state=open]:text-zinc-400">
                      <X className="h-4 w-4 text-zinc-100" />
                      <span className="sr-only">Kapat</span>
                    </DialogClose>
                      ...
                      {searchResults.length > 0 ? (
                        searchResults.map((user) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <Avatar className="h-10 w-10">
                                <AvatarImage src={user.avatar || 'https://cdn.icon-icons.com/icons2/3550/PNG/512/trainer_man_people_avatar_person_icon_224822.png'} />
                                {!user.avatar && (
                                  <AvatarFallback className="bg-blue-500/10 text-blue-500">
                        ...
                        <div className="text-center py-8 text-zinc-400">
                          {addFriendQuery ? 'Kullanıcı bulunamadı' : 'Aramaya başlayın'}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <Avatar className="h-12 w-12">
                      <AvatarImage src={friend.avatar || 'https://cdn.icon-icons.com/icons2/3550/PNG/512/trainer_man_people_avatar_person_icon_224822.png'} />
                      {!friend.avatar && (
                        <AvatarFallback className="bg-blue-500/10 text-blue-500">
