    ...
    <>
      ...
      <div className="bg-zinc-950 text-zinc-50 min-h-screen pt-16">
        ...
        <div className="relative container mx-auto px-4 py-24">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-20 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]">
